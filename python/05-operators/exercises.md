...
1. **Read [README.md](./README.md)** — Understand the concepts and conventions for each operator type.
...
- [README.md](./README.md) — Operator categories, conventions, and examples
